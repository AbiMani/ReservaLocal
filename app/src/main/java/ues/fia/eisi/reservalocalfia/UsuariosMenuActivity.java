...
public class UsuariosMenuActivity extends ListActivity  {

    String[] menu={"Insertar Registro","Actualizar Registro","Consultar Registro","Eliminar Registro"};
    String[] activities={"UsuarioInsertarActivity","UsuarioActualizarActivity","UsuarioConsultarActivity","UsuarioEliminarActivity"};
